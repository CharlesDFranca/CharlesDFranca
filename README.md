...
Atualmente, estou aprofundando meus estudos em **TypeScript**, **Node.js** e **NestJS**, buscando escrever código que seja fácil de entender, testar e evoluir, e não apenas código que “funciona”.

Tenho grande interesse em engenharia de software de verdade: regras de negócio claras, responsabilidades bem definidas e decisões técnicas conscientes.
...
> _"Antes de escrever código, eu penso no problema.  
> Código é consequência de boas decisões."_

---

⭐ Fique à vontade para explorar os repositórios  
🤝 Aberto a colaborações, aprendizado e projetos interessantes
